    ...
    <section className="mt-10 rounded-xl bg-[#0A1128] p-6 sm:p-8 lg:mt-14 lg:p-10">
      <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center lg:gap-12">
        <div className="relative pb-4">
          <div className="flex items-center justify-center rounded-lg bg-white p-8 lg:min-h-[210px]">
            <Image
              src={content.logo}
              alt={content.logoAlt}
              width={435}
        ...
        <div>
          ...
          <div className="mt-6 flex items-start gap-3 rounded-lg bg-white/[0.06] p-4">
