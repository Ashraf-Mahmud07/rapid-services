        ...
        return (
          ...
          >
            <button
              ...
              className="flex w-full cursor-pointer items-center justify-between gap-3 px-4 py-4 text-start lg:gap-4 lg:px-[22px] lg:py-5"
            >
              ...
              <span
                className={cn(
                  "flex size-[26px] flex-none items-center justify-center rounded-full",
            ...
            {isOpen && (
              <p
                ...
                className="px-4 pb-4 text-sm leading-[1.6] text-[#5a5f63] lg:px-[22px] lg:pb-[22px] lg:text-[15px]"
              >
                {item.answer}
              </p>
            )}
...
export default function FaqSection() {
  ...
  return (
    <section className="mt-14 mb-16 sm:mt-16 sm:mb-20 lg:mt-20 lg:mb-24">
      <div className="mb-5 flex flex-col items-start gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-4 lg:mb-[30px]">
        <h2 className="text-[28px] font-bold text-[#17181a] sm:text-[34px] lg:text-[40px]">FAQ</h2>
        <a href="#contact-form" className="text-sm text-primary underline lg:text-[15px]">
          Ask us something else
        </a>
      </div>
      <div className="grid items-start gap-4 lg:grid-cols-2 lg:gap-[22px]">
