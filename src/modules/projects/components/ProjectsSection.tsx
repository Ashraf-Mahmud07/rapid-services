      ...
      <div className="overflow-hidden rounded-xl border border-gray-200 bg-white">
        ...
        <div className="flex min-h-[550px] flex-col lg:flex-row">
          ...
          <div className="flex w-full flex-shrink-0 flex-col border-b border-gray-100 bg-[#f8f9fa] py-6 lg:h-[630px] lg:w-[280px] lg:self-start lg:border-r lg:border-b-0 lg:py-8">
            <div className="mb-6 flex-shrink-0 px-8 text-[11px] font-bold tracking-widest text-gray-400 uppercase">
              Who We Serve
            </div>
            ...
            <div className="mt-6 flex-shrink-0 px-6 pt-4 lg:mt-auto">
              <p className="mb-3 text-[13px] leading-relaxed text-gray-500">
                ...
                <br />
                Most projects are a mix of these.
              </p>
              <Link
                href={ROUTES.CONTACT}
          ...
          <div className="flex-1 border-b border-gray-100 bg-white p-6 md:p-8 lg:border-b-0 lg:p-10">
            ...
            {/* Large Image Area */}
            <div className="relative mb-10 h-[280px] w-full overflow-hidden rounded-2xl md:h-[360px]">
              <Image src={project1Image} alt={activeData.title} fill className="object-cover" />
              {activeData.badge && (
                <div className="absolute top-4 left-4 rounded-full bg-white/90 px-3 py-1.5 text-[10px] font-bold tracking-widest text-gray-900 uppercase backdrop-blur-sm">
                  {activeData.badge}
                </div>
              )}
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2 md:gap-6">
              <div className="rounded-lg border border-gray-100 bg-[#f8f9fa] p-5 md:p-8">
                <h4 className="mb-5 text-[15px] font-bold text-gray-900">
                  {activeData.featuresTitle}
                </h4>
